...
export const ListWorkOrdersResponseItem = zod.object({
  ...
  "estimatedWorkMinutes": zod.number().nullish(),
  "aiReminderEnabled": zod.boolean().optional(),
  "aiReminderScenarioIds": zod.array(zod.string()).optional(),
  "aiNotifySupervisorOnDelay": zod.boolean().optional(),
  "aiReminderRuleSource": zod.string().nullish(),
  "aiReminderCustomConfig": zod.record(zod.string(), zod.any()).nullish(),
...
export const CreateWorkOrderBody = zod.object({
  ...
  "aiReminderScenarioIds": zod.array(zod.string()).optional(),
  "aiNotifySupervisorOnDelay": zod.boolean().optional(),
  "aiReminderRuleSource": zod.enum(["company_default", "custom"]).optional(),
  "aiReminderCustomConfig": zod.record(zod.string(), zod.any()).optional(),
  "equipmentItems": zod.array(zod.object({
  "brand": zod.string().optional(),
  "model": zod.string().optional(),
  "quantity": zod.number().optional(),
