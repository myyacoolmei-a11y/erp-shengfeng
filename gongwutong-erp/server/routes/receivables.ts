...
import { requireFeature, requireCompanyModule } from "../lib/auth";
...
router.use("/receivables", requireFeature("receivables"), requireCompanyModule("accounts_receivable", "invoices"));
